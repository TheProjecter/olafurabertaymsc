...
void Sphere::init(float radius, UINT numSlices, UINT numStacks)
{
    ...
    vbd.ByteWidth = sizeof(Structs::SOLID_VERTEX) * mNumVertices;
...
*/
	...
	vertices.push_back( Structs::SOLID_VERTEX(D3DXVECTOR3(0.0f, -mRadius, 0.0f), D3DXVECTOR3(0.0f, -1.0f, 0.0f), D3DXVECTOR2(0.0f, 1.0f)) );
	vertices.push_back( Structs::SOLID_VERTEX(D3DXVECTOR3(0.0f, mRadius, 0.0f), D3DXVECTOR3(0.0f, 1.0f, 0.0f), D3DXVECTOR2(0.0f, 0.0f)) );
