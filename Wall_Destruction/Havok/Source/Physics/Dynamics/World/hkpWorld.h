...
class hkpWorld : public hkReferencedObject
{
	public:
		...
		void findInitialContactPointsOfAllEntities( );
			...
			/// Info returned from getMemUsageForIntegration()
		struct MemUsageInfo
		{
			...
			/// hkMemory.
			/// ###ACCESS_CHECKS###( [this,HK_ACCESS_RO] );
		void getMemUsageForIntegration(MemUsageInfo& infoOut );
...
#	endif
	...
	public:
		...
		class hkpCollisionCallbackUtil*          m_collisionCallbackUtil; // +nosave
