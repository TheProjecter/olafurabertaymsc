...
struct hkpConstraintSolverResources
{
	...
	BufferState<hkpJacobianSchema> m_schemas[2];
...
private:
	...
	public:
		...
		static void HK_CALL initializeSolverState(hkStepInfo& stepInfo, hkpSolverInfo& solverInfo, hkpConstraintQueryIn& constraintQueryIn, char* buffer, int bufferSize, hkpConstraintSolverResources& s);
