...
extern "C"
{
	...
	void HK_CALL hkAgentNmMachine_Process( hkpAgent1nTrack& agentTrack, const hkpAgent3ProcessInput& input, const HK_SHAPE_CONTAINER* shapeContainerA, const HK_SHAPE_CONTAINER* shapeCollectionB, const hkShapeKeyPair* hitList, hkpProcessCollisionOutput& output  );
