...
class hkpConvexVerticesShape : public hkpConvexShape
{
	...
	//protected:
		...
		// a pointer to a convex piece in the compressed mesh (used for decompressing convex vertices on the fly)
		const hkpCompressedMeshShape::ConvexPiece* m_convexPiece; //+default(0) +serialized(false)
