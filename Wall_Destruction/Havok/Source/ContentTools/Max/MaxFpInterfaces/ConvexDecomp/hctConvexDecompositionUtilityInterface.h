...
public:
	...
	virtual BOOL iDecompose (Tab<INode*>& nodesIn, Tab<INode*>& nodesOut, BOOL detachParts, BOOL singleOut, double guardTolerance, BOOL hideMesh, INT reduceOverlapPasses, INT octreeDepth ) = 0;
	virtual BOOL iCombine (INode* baseNode, Tab<INode*>& origMeshNodes, Tab<INode*>& nodesIn, Tab<INode*>& nodesOut, double accuracyCombine, BOOL singleOutCombine, BOOL genGuards, INT octreeDepth ) = 0;
};
