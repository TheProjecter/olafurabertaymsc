...
class hkSerializeDeprecated : public hkReferencedObject, public hkSingleton<hkSerializeDeprecated>
{
	public:
		...
		virtual hkResult saveXmlPackfile( const void* object, const hkClass& klass, hkStreamWriter* writer, const hkPackfileWriter::Options& options, hkPackfileWriter::AddObjectListener* userListener );
