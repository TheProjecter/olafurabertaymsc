...
HK_PATCH_BEGIN("hkbExtractRagdollPoseModifier", 0, "hkbExtractRagdollPoseModifier", 1)
	...
	HK_PATCH_MEMBER_ADDED("poseMatchingBone1", TYPE_INT, HK_NULL, 0)
	HK_PATCH_MEMBER_ADDED("poseMatchingBone2", TYPE_INT, HK_NULL, 0)
	HK_PATCH_MEMBER_ADDED("enableComputeWorldFromModel", TYPE_BYTE, HK_NULL, 0)
	HK_PATCH_FUNCTION(hkbExtractRagdollPoseModifier_0_to_1)
HK_PATCH_END()
...
HK_PATCH_BEGIN("hkbGeneratorTransitionEffect", 0, "hkbGeneratorTransitionEffect", 1)
        HK_PATCH_MEMBER_ADDED("syncToGeneratorStartTime", TYPE_BYTE, HK_NULL, 0)
		HK_PATCH_FUNCTION(hkbGeneratorTransitionEffect_0_to_1)
HK_PATCH_END()
...
HK_PATCH_BEGIN("hkbStateMachineProspectiveTransitionInfo", 1, HK_NULL, HK_CLASS_REMOVED)
HK_PATCH_END()

HK_PATCH_BEGIN("hkbStateMachineActiveTransitionInfo", 0, HK_NULL, HK_CLASS_REMOVED)
	HK_PATCH_MEMBER_REMOVED("transitionInfo", TYPE_OBJECT, "hkbStateMachineTransitionInfo", 0)
	HK_PATCH_MEMBER_REMOVED("transitionEffect", TYPE_OBJECT, "hkbTransitionEffect", 0)
	HK_PATCH_MEMBER_REMOVED("fromStateId", TYPE_INT, HK_NULL, 0)
	HK_PATCH_MEMBER_REMOVED("toStateId", TYPE_INT, HK_NULL, 0)
	HK_PATCH_MEMBER_REMOVED("isReturnToPreviousState", TYPE_BYTE, HK_NULL, 0)
	HK_PATCH_DEPENDS("hkbNode", 1)
	HK_PATCH_DEPENDS("hkBaseObject", 0)
	HK_PATCH_DEPENDS("hkbGenerator", 0)
	HK_PATCH_DEPENDS("hkbTransitionEffect", 0)
...
HK_PATCH_BEGIN("hkbFootIkModifier", 2, "hkbFootIkModifier", 3)
	HK_PATCH_MEMBER_ADDED("forwardAlignFraction", TYPE_REAL, HK_NULL, 0)
	HK_PATCH_MEMBER_ADDED("sidewaysAlignFraction", TYPE_REAL, HK_NULL, 0)
	HK_PATCH_MEMBER_ADDED("sidewaysSampleWidth", TYPE_REAL, HK_NULL, 0)
	HK_PATCH_FUNCTION(hkbFootIkModifier_2_to_3)
HK_PATCH_END()
...
HK_PATCH_BEGIN("hkbPoseMatchingGenerator", 0, "hkbPoseMatchingGenerator", 1)
	HK_PATCH_MEMBER_ADDED("worldFromModelRotation", TYPE_VEC_4, HK_NULL, 0)
	HK_PATCH_FUNCTION(hkbPoseMatchingGenerator_0_to_1)
HK_PATCH_END()

HK_PATCH_BEGIN("hkbGetUpModifier", 1, "hkbGetUpModifier", 2)
	HK_PATCH_MEMBER_ADDED("groundNormal", TYPE_VEC_4, HK_NULL, 0)
	HK_PATCH_MEMBER_ADDED("alignWithGroundDuration", TYPE_REAL, HK_NULL, 0)
...
HK_PATCH_BEGIN(HK_NULL, HK_CLASS_ADDED, "hkbSetWorldFromModelModifier", 0)
        ...
        HK_PATCH_MEMBER_ADDED("setTranslation", TYPE_BYTE, HK_NULL, 0)
        HK_PATCH_MEMBER_ADDED("setRotation", TYPE_BYTE, HK_NULL, 0)
HK_PATCH_END()

HK_PATCH_BEGIN("hkbDemoConfig", 2, "hkbDemoConfig", 3)
	HK_PATCH_MEMBER_ADDED("forceLoad", TYPE_BYTE, HK_NULL, 0)
HK_PATCH_END()
