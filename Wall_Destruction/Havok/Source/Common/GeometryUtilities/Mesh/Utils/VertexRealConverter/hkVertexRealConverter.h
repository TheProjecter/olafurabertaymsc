...
class hkVertexRealConverter
{
    public:
		...
		int findElementOffset(hkVertexFormat::DataUsage usage, int subUsage) const;
	...
	protected:
		...
		{
			DST_TYPE_UNKNOWN,
			DST_TYPE_FLOAT32_POSITION,		///
			DST_TYPE_FLOAT32_NORMAL,		///
			DST_TYPE_FLOAT32_GENERAL,		///
			DST_TYPE_FLOAT32_CLAMP1,		///
			DST_TYPE_FLOAT32_CLAMP2,		///
			DST_TYPE_FLOAT32_CLAMP3,		///
			DST_TYPE_FLOAT32_CLAMP4,		///
			DST_TYPE_ARGB32,				///
		};
