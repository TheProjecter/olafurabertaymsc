...
//
void hkAabbUtil::calcAabb( const hkVector4& center, hkReal innerRadius, hkAabb& aabbOut)
{
	hkVector4	ir;
	ir.setAll(innerRadius);
...
{
	return(0.5f*(hkReal)aabb.m_min.distanceTo3(aabb.m_max));
}
