...
struct hkStackMemory
{
	public:
#if !defined(HK_PLATFORM_PS3_SPU)
		HK_FORCE_INLINE hkStackMemory();
		HK_FORCE_INLINE ~hkStackMemory();
		static hkStackMemory& getInstance();
#else
		static hkStackMemory s_instance;
		static inline hkStackMemory& getInstance() { return s_instance; }
#endif
		...
		HK_FORCE_INLINE const void* getStackStart() { return m_start; }
...
#include <Common/Base/Memory/Util/Stack/hkStackMemory.inl>
