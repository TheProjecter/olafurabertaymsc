...
typedef hkMemoryAllocator::MemoryStatistics hkMemoryStatistics;
...
class hkFreeList
{
    public:
        ...
        hkFreeList(hk_size_t elementSize,hk_size_t alignment,hk_size_t blockSize,
            hkFreeListAllocatorServer* alloc = &hkDefaultFreeListMemoryServer::getInstance());
		...
		void init(hk_size_t elementSize, hk_size_t alignment, hk_size_t blockSize, hkFreeListAllocatorServer* memoryServer = &hkDefaultFreeListMemoryServer::getInstance());
    ...
    protected:
		...
		void _init(hk_size_t elementSize, hk_size_t align, hk_size_t blockSize, hkFreeListAllocatorServer* memoryServer);
