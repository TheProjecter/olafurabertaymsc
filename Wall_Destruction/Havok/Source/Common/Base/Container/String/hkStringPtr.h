...
#include <Common/Base/Container/String/hkString.h>
	...
	/// allocated, the lowest bit of the pointer being used as as a
...
class hkStringPtr
{
	public:
		...
		hkStringPtr(const char* string);
			...
			/// Construct hkStrRef from const char*, null terminated after len characters.
