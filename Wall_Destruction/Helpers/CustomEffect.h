...
namespace Helpers{
	...
	public:
		...
		// creates the vertex buffer every time, since the geometry shader is considered a special worker for the cpu
	...
	private:
		...
		std::map<string, ID3D10EffectVariable*, ProjectStructs::NameComparer> effectVariables;
